...
def estimate_country_factor_beta(y, x):
    ...
    beta_smooth, P_smooth = kalman_tvp_univariate(y, x, q_var, r_var)
    return beta_smooth, P_smooth, q_var, r_var, result.fun
...
def estimate_all_betas():
    ...
    for i, country in enumerate(countries):
        ...
        for k, fcol in enumerate(FACTOR_COLS):
            ...
            beta_smooth, P_smooth, q_var, r_var, nll = estimate_country_factor_beta(dy, dx)
